...
class DBLPContentHandler(xml.sax.ContentHandler):
  ...
  def characters(self, content):
      ...
      #enc_cont=content.replace('\\','\\\\').encode('utf-8')
      #print(type(enc_cont))
      #print(type(DBLPContentHandler.content))
      #purecont=enc_cont.replace(b'\\',b'\\\\')
      DBLPContentHandler.content += content #content.encode('utf-8').replace('\\','\\\\')
